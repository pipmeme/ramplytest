  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      if (isMobile) {
        ...
        alert("PDF opened in new tab. Please save it from there.")
      } else {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-6xl space-y-8">
            ...
            <div className="text-center">
              ...
              <p className="text-lg text-muted-foreground">Complete path to profitability with 12-month projections</p>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-4">
              ...
              >
                ...
                <CardContent>
                  <p className={`text-3xl font-bold ${metrics.currentProfit >= 0 ? "text-green-600" : "text-red-600"}`}>
                ...
                <div className="h-[400px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={chartData}>
                      ...
                      <YAxis
                        label={{ value: `Amount (${CURRENCIES[currency].symbol})`, angle: -90, position: "insideLeft" }}
                      />
                      <Tooltip
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Adjust these sliders to see how changes affect your break-even point</CardDescription>
              </CardHeader>
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          ...
                          {Math.ceil((Number.parseFloat(fixedCosts) * 0.9) / metrics.contributionMargin)} units - that's{" "}
                  ...
                  <>
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Look for opportunities to automate processes and improve efficiency to increase profitability.
                        </p>
                      </div>
                    </div>
                  </>
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Provide your basic business metrics to calculate your break-even point</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
